...
class DatabaseInterfaceSelectByTechId < DatabaseInterface
	...
	def load_all_refs()
		...
		ref_rope_list = load_ref_rope_list()
		ref_sex_list = load_ref_sex_list()
		ref_sex_rule_list = load_ref_sex_rule_list()
    ...
    #
		# @logger.debug("RefRope")
		# @logger.debug(ref_rope_list)
    #
		# @logger.debug("RefSex")
		# @logger.debug(ref_sex_list)
    #
		# @logger.debug("RefSexRule")
		# @logger.debug(ref_sex_rule_list)
