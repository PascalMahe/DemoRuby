	...
	def test_select_meeting
		...
		begin
			...
			@logger.debug("@ref_list_hash[:ref_track_condition_list][\"Terrain bon\"] : " + @ref_list_hash[:ref_track_condition_list]["Terrain bon"].to_s)
	...
	def test_select_race
		...
		begin
			...
			@logger.debug("Fetched meeting w/ id = -1 : " + meeting.to_s)
